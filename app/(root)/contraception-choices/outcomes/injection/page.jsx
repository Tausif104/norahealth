          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 md:p-10 items-stretch">
            ...
            <div className='flex flex-col h-full space-y-6 relative before:content-none lg:before:content-[""] before:absolute before:bg-[#CE8936] before:w-[1px] before:h-full before:top-0 before:right-0 pr-5'>
              ...
              <p className="text-base text-[#3A3D42]">
                ...
                administered every 8-13 weeks, depending on the brand. It works
                by preventing ovulation and thickening cervical mucus. The
                injection is around 94% effective with typical use and is an
                option for those who prefer not to take daily pills.
              </p>
              ...
              <div className="text-base text-[#3A3D42] space-y-3">
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Can reduce period pain and bleeding for some users</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full md:pl-8 space-y-6">
              ...
              <div className="text-base text-[#3A3D42] space-y-3">
                <ul className="list-disc list-inside space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Reduces bone density therefore not suitable for teenagers
                      or if perimenopause
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Irregular periods or stopping periods altogether</span>
                  </li>
              ...
              <p className="text-base text-[#3A3D42]">
                Nora Health do not offer services for injections just yet, but we
