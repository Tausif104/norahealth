  ...
  return (
    <div className='border border-[#EDEDED] inline-block rounded-[16px] px-7 py-4  shadow-[0_10px_80px_rgba(30,96,221,0.1)]'>
      <span className='flex items-center'>
        {prefix && (
          <span className='text-theme lg:text-4xl text-2xl font-semibold'>
            {prefix}
          </span>
        )}
        <CountingNumber
          className='text-theme lg:text-5xl text-2xl font-semibold'
          number={num}
          inView={true}
      ...
      <p className='text-[#5C616C] lg:text-[20px] text-[12px] mt-2'>{label}</p>
    </div>
  )
}
